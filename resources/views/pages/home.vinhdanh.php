...
<audio id="bgMusic" autoplay loop>
  <source src="{{asset('storage/app/Victory.mp3')}}" type="audio/mpeg">  Trình duyệt của bạn không hỗ trợ audio.
</audio>

<button id="musicToggle" style="
    position:fixed; top:50%; right:5px; z-index:9999; padding:10px 15px; 
    background:#609de7; color:#fff; border:none; border-radius:8px; cursor:pointer;
">
  🔊 Bật
</button>
<script>
...
<div class="honor-bar">
  <div class="scroll-text">
    <div class="rank">
      ...
      <div class="info">
        <span><strong>Nguyễn Minh Toàn</strong></span>
        <span>DS: 378.088.000 | Lương & Thưởng: <strong style="color:green">30,253,384đ</strong></span>
      </div>
    </div>
    ...
    <div class="rank">
      ...
      <div class="info">
        <span><strong>Nguyễn Thị Quỳnh Như</strong></span>
        <span>DS: 354.060.000 | Lương & Thưởng: <strong style="color:green">26,333,741đ</strong></span>
      </div>
    </div>
    ...
    <div class="rank">
      ...
      <div class="info">
        ...
        <span>DS: 327.400.000 | Lương & Thưởng: <strong style="color:green">22,223,418đ</strong> </span>
      </div>
    </div>
  </div>
</div>
...
const avatars = [
  "{{asset('public/img/tuyet.enc')}}",
  "{{asset('public/img/toan.enc')}}",
  "{{asset('public/img/nhu.enc')}}"
];
const icons = ["❤️","👍","😂"];
 ...
 function dropAvatar() {
    ...
    // img.src = "{{asset('public/img/tuyet.enc')}}";

    const arr = [1, 2, 0];
    var randomNumber = arr[Math.floor(Math.random() * arr.length)];
    console.log(randomNumber);
    img.src = avatars[randomNumber];
