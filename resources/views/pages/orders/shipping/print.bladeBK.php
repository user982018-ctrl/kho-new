...
<div class="content page-break line" style="font-weight: bold; position: relative">
    <div style="padding: 2px; display: flex; align-items: center; font-size: 10px">
        ...
        <div style="padding-left: 4px; width: 65%">
            <div style="display: flex; align-items: center; justify-content: space-between">
                <div class="module line-clamp-2">Anh Nguyễn Thành Công</div>
                <div>******3066</div>
            </div>
            <div class="module line-clamp-2">ấp Chà Là, xã Trần Phán, huyện Đầm Dơi, tỉnh Cà Mau</div>
        </div>
    </div>
    <div style="padding: 2px; border-bottom: 1px dotted">
        <img
            width="100%"
            height="auto"
            src="https://online-gateway.ghn.vn/barcode/api/v1/barcode/generate?code=GY9E9MF4_1&type=128A&width=820&height=150"
            atl="barcode"
        ...
        <div style="display: flex; justify-content:  space-between ; align-items: center; padding-top: 2px;">
            <div>
                ...
                <div style="font-size: 16px">CPTT</div>

                <div style="font-size: 8px; font-weight: 700;   ;">23:25:36 20/09/25</div>
            </div>
            ...
            <div style="font-size: 12px">
                <div style="font-size: 14px; border: 1px solid; padding: 1px;">1/4</div>

            </div>

        </div>
    </div>
    <div style="font-size: 11px; padding: 2px 0; border-bottom: 1px dotted; text-transform: uppercase"
        class="module line-clamp-1">
    ...
    <div style="display: flex; align-items: center; justify-content: space-between; border-bottom: 1px dotted">
        ...
        <div style="height: 50px; width: 50px">
            <img
                ...
                height="100%"
                height="auto"
                src="https://online-gateway.ghn.vn/barcode/api/v1/barcode/generate?code=GY9E9MF4_1&type=QR&width=200&height=200"
                atl="barcode"
            />
        </div>
    </div>

    <div style="font-size: 14px; padding: 2px 0; border-bottom: 1px dotted" class="module line-clamp-3">
    ...
    <div style="font-size: 11px; padding: 2px 0; border-top: 1px dotted; text-transform: uppercase">
    ...
    <div class="items">
        ...
        <div style="
                ...
                font-weight: 500;
            ">
            <div style="width: 90%; word-break: break-all; font-weight: bold" class="module line-clamp-10">
                Men vi sinh Super Aqua 20L
            </div>
            <div style="border: none">1</div>
        </div>
    ...
    <div style="
        ...
        ">
        <div>Ký tên</div>
        <div>Xác nhận đã nhận hàng nguyên vẹn</div>
        <div style="text-align: left; width: 76px;">
            <div style="margin-left: 3px; margin-bottom: 2px;">
                <img src="https://cdn.ghn.vn/images/logo-ghn/GHN_Black.png" width="100" />
            </div>

        </div>

        <div>Tờ 1 của ĐH 1/1</div>
    </div>
</div>


    @if (isset($code["bar_code"]))
        <img src="data:image/png;base64,{{ $code["bar_code"] }}" alt="QR Code">
    @endif

    @if (isset($code["qr_code"]))
        <img src="data:image/png;base64,{{ $code["qr_code"] }}" alt="QR Code">
    @endif
@endforeach
