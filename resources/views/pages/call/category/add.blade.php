        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="tab-content rounded-bottom">
                    <form action="{{route('category-call-save')}}" method="POST">
                        {{ csrf_field() }}
                        <input value="{{$categoryCall->id}}" name="id" type="hidden">
                        <div class="tab-pane p-3 active preview" role="tabpanel" id="preview-1000">
                            <div class="row">
                                <div class="mb-3 col-8">
                                    <label class="form-label" for="nameIP">Loại</label>
                                    <input required class="form-control" value="{{$categoryCall->name}}" name="name" id="nameIP" type="text">
                                ...
                                <div class="mb-3 col-8">
                                    ...
                                    <div class="form-check">
                                        <input <?=  $categoryCall->status == 0 ? 'checked' : '' ?> class="form-check-input" type="radio" name="status" value="0"
